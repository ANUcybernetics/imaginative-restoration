...
export declare const intersectLineLine: (a: ReadonlyVec, b: ReadonlyVec, c: ReadonlyVec, d: ReadonlyVec, eps?: number) => IntersectionResult;
/**
 ...
 */
export declare const isParallelLine: FnU4<ReadonlyVec, boolean>;
